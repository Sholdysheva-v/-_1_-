...
//                // Пропускаем токены, если мы уже сообщили об ошибке для этого токена
//                if (currentState == State.Error && i <= lastErrorTokenIndex)
//                {
//                    i++;
//                    continue;
//                }
